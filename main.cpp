...
QVector<QVector<int>> mixColums(const QVector<QVector<int>> src,const QVector<QVector<int>> a, const QVector<QVector<int>> gfl, const QVector<QVector<int>> gfe, const QString numInHex) {
/*//    QVector<QVector<int>> cpy = src;
//    for (int i(0); i < 1; i++) {
...
//    const QVector<int> input = {0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x07, 0x34};
    ...
    const QVector<QVector<int>> gf_e = {
    ...
    const QVector<QVector<int>> gf_l = {
    ...
    for (int i(0); i < Nr-1; i++) {
        ...
        test = shiftRow(test);
        test = mixColums(test, a, gf_l, gf_e, numInHex);
...
//        qDebug()<<decrip;
        ...
        decrip = mixColums(decrip, a_inv, gf_l, gf_e, numInHex);
        qDebug()<<decrip;
    }
    qDebug()<<"***********************************************************";
    decrip = subBytes(decrip, inv_sbox, numInHex);
